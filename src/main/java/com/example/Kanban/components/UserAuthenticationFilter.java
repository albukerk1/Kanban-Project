package com.example.Kanban.components;
...
import com.example.Kanban.service.JwtTokenService;
...
public class UserAuthenticationFilter extends OncePerRequestFilter {
    ...
    private boolean checkIfEndpointIsNotPublic(HttpServletRequest request) {
        ...
        return !Arrays.asList(SecurityConfiguration.ENDPOINTS_WITH_FREE_AUTHENTICATION).contains(requestURI);
    }
